  ...
  function f() {
    function e(e) {
      ...
      if (
        ...
        !(
          (_ = new WebAssembly.Memory({ initial: p / 65536, maximum: 32768, shared: !0 }))
      ...
      var E = {
        ...
        Xa: function () {},
        Ea: function () {
          (E.receiveObjectTransfer = E.Ha),
            (E.threadInit = E.xa),
            (E.setExitStatus = E.Ja),
            (z = !1);
        },
        aa: {},
        Ja: function () {},
        ...
        Fa: function (r, a) {
          (r.onmessage = e => {
            ...
            (r.onerror = e => {
              throw (
                (m('worker sent an error! ' + e.filename + ':' + e.lineno + ': ' + e.message), e)
              );
            }),
            u &&
      ...
      function Te(e) {
        return (
          (e = 2 < e ? y(e) : e),
          Oe[e] || ('undefined' != typeof document ? document.querySelector(e) : void 0)
        );
      }
      function Ce(e, t, n) {
        var r,
            ...
            !s.va && s.Ra
              ...
              : ((e = !1),
                (s = s.va ? s.va : s).ka &&
                  s.ka.ja &&
                  (e =
                    0 === (e = s.ka.ja.getParameter(2978))[0] &&
                    0 === e[1] &&
                    e[2] === s.width &&
                    e[3] === s.height),
                (s.width = t),
      ...
      function Ne(e, t, n, r) {
        return d
          ? I(10, 1, e, t, n, r)
          : ((e = Ae.Va(e)), (t = Ae.Ta(e, t, n)), (h()[r >> 2] = t), 0);
      }
              ...
              return i(n, (e = new Date(e.$ + 1900, e.ea, e.ia))) < 0
                ? o(
                    Math.ceil(
                      (31 -
                        n.getDate() +
                        ($e(R(e.getFullYear()) ? O : T, e.getMonth() - 1) - 31) +
                        e.getDate()) /
                        7,
                    ),
                    2,
      ...
      var ze,
        ...
        Ke =
          (!(function () {
            ...
            var a = { a: Je };
            if (
              (d || (S++, c.monitorRunDependencies && c.monitorRunDependencies(S)),
              c.instantiateWasm)
            )
              try {
        ...
        tt =
          ((c._emscripten_current_thread_process_queued_calls = function () {
            return (c._emscripten_current_thread_process_queued_calls = c.asm.N).apply(
              null,
              arguments,
            );
          }),
        ...
        nt = (c._emscripten_main_thread_process_queued_calls = function () {
          return (nt = c._emscripten_main_thread_process_queued_calls = c.asm.P).apply(
            null,
            arguments,
          );
        }),
        rt = (c._emscripten_run_in_main_runtime_thread_js = function () {
          return (rt = c._emscripten_run_in_main_runtime_thread_js = c.asm.Q).apply(
            null,
            arguments,
          );
        }),
      ...
      function dt(o) {
        function e() {
          if (!ze && ((ze = !0), (c.calledRun = !0), !J)) {
            if (
              (d || k(fe), d || k(le), F(c), c.onRuntimeInitialized && c.onRuntimeInitialized(), mt)
            ) {
              var e = o,
          ...
          var a = {
              string: function (e) {
                ...
                return (
                  null != e &&
                    0 !== e &&
                    ((t = 1 + (e.length << 2)), (n = r = j(t)), w(e, l(), n, t)),
                  r
                );
              },
              array: function (e) {
          ...
          ? ((c = require('path')),
            ...
            'number' == typeof enginePartsCount &&
              (n.wasmBinary = (function (e) {
                for (
                  var t = require('fs'), n = c.extname(s), r = s.slice(0, -n.length), a = [], o = 0;
                  o < e;
                  ++o
                )
